          ...
          <div style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                ...
                <XAxis type="number" dataKey="PoU_2023" name="PoU" unit="%" stroke="var(--text-secondary)" domain={['dataMin - 1', 'dataMax + 1']} tickFormatter={(val) => Number(val).toFixed(0)} />
                <YAxis type="number" dataKey="Stunting_2023" name="Stunting" unit="%" stroke="var(--text-secondary)" domain={['dataMin - 2', 'dataMax + 2']} tickFormatter={(val) => Number(val).toFixed(0)} />
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          ...
          <div style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="var(--glass-border)" />
                <XAxis type="number" dataKey="Kemiskinan_Total_2023" name="Kemiskinan" unit="%" stroke="var(--text-secondary)" domain={['dataMin - 1', 'dataMax + 1']} tickFormatter={(val) => Number(val).toFixed(0)} />
                <YAxis type="number" dataKey="Stunting_2023" name="Stunting" unit="%" stroke="var(--text-secondary)" domain={['dataMin - 2', 'dataMax + 2']} tickFormatter={(val) => Number(val).toFixed(0)} />
                <ZAxis dataKey="Provinsi" name="Provinsi" />
                <Tooltip content={<CustomTooltip />} cursor={{strokeDasharray: '3 3'}} />
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          ...
          <div style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="var(--glass-border)" />
                <XAxis type="number" dataKey="Sanitasi_Layak_2023" name="Sanitasi" unit="%" stroke="var(--text-secondary)" domain={['dataMin - 5', 'dataMax + 5']} tickFormatter={(val) => Number(val).toFixed(0)} />
                <YAxis type="number" dataKey="Stunting_2023" name="Stunting" unit="%" stroke="var(--text-secondary)" domain={['dataMin - 2', 'dataMax + 2']} tickFormatter={(val) => Number(val).toFixed(0)} />
                <ZAxis dataKey="Provinsi" name="Provinsi" />
                <Tooltip content={<CustomTooltip />} cursor={{strokeDasharray: '3 3'}} />
